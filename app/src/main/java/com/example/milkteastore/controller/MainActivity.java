...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main); // đảm bảo file XML này trùng tên layout XML

        View rootView = findViewById(R.id.rootLayout); // đổi từ R.id.main -> R.id.rootLayout
